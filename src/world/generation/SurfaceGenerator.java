...
public class SurfaceGenerator
{
    ...
    public SurfaceGenerator(int width, int height)
    {
        ...
        ds1 = new DiamondSquare(width, height, stepSize,  scale, 0.65f, seed);
        ds2 = new DiamondSquare(width, height, stepSize/2, scale/2, 0.99f, seed+1);
        map1 = ds1.getValues();
        map2 = ds2.getValues();
